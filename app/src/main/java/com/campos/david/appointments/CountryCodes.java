...
/**
 * Based on this stackOverflow answer http://stackoverflow.com/questions/5402253/getting-telephone-country-code-with-android
 * <p/>
 ...
 * @author David Campos R (modified)
 */
public class CountryCodes {
    private static final String[] sCountries = {
    ...
    private static final String[] sCodes = {
    ...
    public CountryCodes(boolean reorderByCode) {
        if (reorderByCode) {
            Util.quickSort(sCodes, sCountries, 0, sCodes.length - 1);
        }
    }
